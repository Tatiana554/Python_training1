...
class TestTestaddgroup():
  ...
  def test_testaddgroup(self):
    ...
    self.driver.find_element(By.NAME, "group_name").send_keys("группа 2")
    self.driver.find_element(By.NAME, "group_header").click()
    self.driver.find_element(By.NAME, "group_header").send_keys("444")
    self.driver.find_element(By.NAME, "group_footer").click()
    self.driver.find_element(By.NAME, "group_footer").send_keys("555")
